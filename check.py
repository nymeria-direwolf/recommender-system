...
def main():
    ...
    page_selection = st.sidebar.multiselect("Try", page_options, default=None)



########################################################################################
    if "Recommends" in page_selection  : 
...
#########################################################################################  
    if "Popular on instagram" in page_selection:
...
#########################################################################################
    if "Streetstyle" in page_selection:
