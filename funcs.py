...
def get_item_image_without_jpeg(item_id, resize=True, width=100, height = 150):
    
    path = 'outfits/'+item_id
    image = Image.open(path)
...
def get_item_image_without_jpeg_street(item_id, resize=True, width=100, height = 150):
    
    path = 'streetstyle/'+item_id
    image = Image.open(path)
...
def get_item_image_without_jpeg_formal(item_id, resize=True, width=100, height = 150):
...
def get_item_image_without_jpeg_ethnic(item_id, resize=True, width=100, height = 150):
...
def get_item_image_without_jpeg_tops(item_id, resize=True, width=100, height = 150):
...
def get_item_image_without_jpeg_pants(item_id, resize=True, width=100, height = 150):
...
def get_item_image_without_jpeg_menshirt(item_id, resize=True, width=100, height = 150):
    
    path = 'menshirt/'+item_id
    image = Image.open(path)
